...
public class SpecificationServiceImpl implements SpecificationService {
	...
	public void update(Specification specification){
		...
		specificationOptionMapper.deleteByExample(getExample(specification.getSpecification().getId()));
	...
	public Specification findOne(Long id){
		...
		return new Specification(specificationMapper.selectByPrimaryKey(id),specificationOptionMapper.selectByExample(getExample(id)));
	}

	public TbSpecificationOptionExample getExample(Long id){
		TbSpecificationOptionExample example=new TbSpecificationOptionExample();
		TbSpecificationOptionExample.Criteria criteria = example.createCriteria();
		criteria.andSpecIdEqualTo(id);
		return example;
	...
	public void delete(Long[] ids) {
		for(Long id:ids){
			...
			specificationOptionMapper.deleteByExample(getExample(id));
		}		
	}
